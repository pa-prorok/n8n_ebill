...
\includegraphics[scale=0.5]{logo}
 %\parbox[t]{\ADDRwd}{Kontaktinformationen:\\
 %                    Prophet Analytics GmbH \\
 %                    Ochsenwerder Landstr. 177 \\
%										 21037 Hamburg \\
%                     Telefon: +49 176 21752632 \\
%                     }
 }
\signature{Jens Mander}
\place{Hamburg}
\address{\briefkopf}
\phone{(0127)}{806-0815}
\def\FS{ABC GmbH,
        ABC-Straße 1, 12345\,B\rule[-1ex]{0pt}{0pt}}
